			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="keyWord" title="${message(code: 'message.keyWord.label', default: 'Key Word')}" />
				...
				<g:each in="${messageInstanceList}" status="i" var="messageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${messageInstance.id}">${fieldValue(bean: messageInstance, field: "keyWord")}</g:link></td>
